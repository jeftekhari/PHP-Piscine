...
if ($argc > 1)
{
	...
	else
	{
		...
		preg_match("/([J|j]anvier|[F|f][e|é]vrier|[M|m]ars|[A|a]vril|[M|m]ai|[J|j]uin|[J|j]uillet|[A|a]o[u|û]t|[S|s]eptembre|[N|n]ovembre|[D|d][e|é]cembre)/", $argv[1], $month);
		$m = get_number($month[0]);
		...
		echo mktime($hour[0], $min[0], $sec[0], $m, $num[0], $anne[0]);
		echo "\n";
	}
}	
?>
